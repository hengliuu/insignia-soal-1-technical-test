...
CREATE TABLE `Users` (
    ...
    `lastActivityAt` DATETIME(0) NOT NULL,
    `email` VARCHAR(100) NOT NULL,
    `emailVerified` DATETIME(0) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Users` ADD CONSTRAINT `Users_workspaceId_fkey` FOREIGN KEY (`workspaceId`) REFERENCES `Workspace`(`Id`) ON DELETE RESTRICT ON UPDATE CASCADE;
